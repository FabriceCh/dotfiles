...
require("lazy").setup({
	...
	{ -- Useful plugin to show you pending keybinds.
		...
		config = function() -- This is the function that runs, AFTER loading
			...
			wk.add({
				...
				{ "<leader>gc", group = "git [C]ommit or [C]heckout" },
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			end, { desc = "[S]earch current buffer directory" })
	...
	{ -- LSP Configuration & Plugins
		...
		config = function()
			...
			vim.api.nvim_exec(
				...
				augroup LspAttach
				  autocmd!
				  " For files named 'Tiltfile', set filetype to 'starlark'
				  autocmd BufNewFile,BufRead Tiltfile setlocal filetype=starlark
				augroup END
			      ]],
				false
			)
	...
	-- 	"David-Kunz/gen.nvim",
	-- 	opts = {
	-- 		model = "devstral", -- The default model to use.
